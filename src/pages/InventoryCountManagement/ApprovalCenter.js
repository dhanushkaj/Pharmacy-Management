      ...
      {sessions.length === 0 ? (
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div>
            ...
            {/* Selected Session Details + Approval Actions - Full Width Below */}
            {selectedSession && (
              <div style={{ marginTop: 24 }}>
                ...
                <div style={{ marginBottom: 16, padding: 12, background: '#f5f5f5', borderRadius: 4, border: '1px solid #ddd' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
                    ...
                    <div>
                      <div style={{ fontSize: 12, color: '#666' }}>Total Price Variance</div>
                      <div style={{ fontSize: 16, fontWeight: 'bold', color: '#ff5722' }}>
                        Rs. {(selectedSession.lines?.reduce((sum, l) => sum + ((l.variance || 0) * (l.sellPrice || 0)), 0) || 0).toFixed(2)}
                      </div>
                    </div>
                    <div>
                      <div style={{ fontSize: 12, color: '#666' }}>Avg Selling Price</div>
                ...
                <div style={{ marginTop: 20, paddingTop: 16, borderTop: '2px solid #eee' }}>
                  <h4 style={{ marginBottom: 12, color: '#333' }}>Approval Actions</h4>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 10 }}>
                          <thead>
                            <tr style={{ background: '#f5f5f5', borderBottom: '1px solid #ddd' }}>
                              <th style={{ padding: 6, textAlign: 'left', fontSize: 10 }}>Product</th>
                              <th style={{ padding: 6, textAlign: 'center', fontSize: 10 }}>System Qty</th>
                                ...
                                return (
                                  <tr key={line.id} style={{ borderBottom: '1px solid #f0f0f0' }}>
                                    <td style={{ padding: 6 }}>
                                      ...
                                      <div style={{ fontSize: 9, color: '#666' }}>{line.productCode}</div>
                                    </td>
                                    ...
                                    <td style={{ padding: 6, textAlign: 'center', fontSize: 10 }}>
                                      <input
                                        ...
                                        style={{ width: 45, padding: 3, border: '1px solid #ddd', borderRadius: 2, fontSize: 9 }}
                                      />
                                    </td>
                                    <td style={{ padding: 6, textAlign: 'center', fontWeight: 'bold', color: '#ff9800', fontSize: 10 }}>
                                      {formatVariance(qtyVariance)}
                                    </td>
                                    <td style={{ padding: 6, textAlign: 'center', fontSize: 10 }}>
